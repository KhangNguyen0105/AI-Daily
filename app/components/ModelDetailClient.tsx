    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="border-b py-8">
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <dt className="text-sm text-text-tertiary">Context Window</dt>
            <dd className="text-lg font-medium">
              {formatContextWindow(model.contextWindow)}
            </dd>
          </div>
          <div>
            <dt className="text-sm text-text-tertiary">Model Family</dt>
            <dd className="text-lg font-medium">
              {getModelFamily(model.modelName)}
            </dd>
          </div>
          <div>
            <dt className="text-sm text-text-tertiary">First Collected</dt>
            <dd className="text-lg font-medium">
