    ...
    <>
      <div className="flex items-center gap-2">
        <select
          ...
          className="px-3 py-2 border border-border-secondary rounded-md text-sm bg-bg-primary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-w-[180px] shadow-sm"
        >
